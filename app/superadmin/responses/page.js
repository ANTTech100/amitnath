...
export default function SuperadminQuestions() {
  ...
  const getTemplateName = (templateId) => {
    const idStr =
      typeof templateId === "object" && templateId !== null && templateId._id
        ? templateId._id
        : templateId;
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 to-indigo-900 p-8">
        <h1 className="text-3xl font-bold text-white mb-8">
          Admin Questions (All Organizations)
        </h1>
            ...
            {adminQuestions.length === 0 ? (
              <div className="text-center text-blue-200 py-8">
                ...
                <p className="text-sm text-blue-200/60 mt-2">
                  Admins have not created any questions yet.
                </p>
              </div>
            ) : (
                  ...
                  >
                      ...
                      <div className="flex items-center space-x-4 text-blue-200/80">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm font-medium">
                            {templateQ.questions.length} questions
                          </span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <svg
                    ...
                    <div className="space-y-4">
                      {templateQ.questions.map((question, qIndex) => (
                        <div
                          key={qIndex}
                          className="bg-white/5 backdrop-blur-sm border border-blue-400/10 rounded-lg p-4"
                        >
                          <div className="mb-3">
